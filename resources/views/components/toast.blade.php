 ...
 <div x-data="{
     ...
     addNotification({ variant = 'info', sender = null, title = null, message = null }) {
         ...
         if (this.soundEffect) {
             ...
             const notificationSound = new Audio('https://www.myinstants.com/media/sounds/notification_o14egLP.mp3')
     ...
     <div x-on:mouseenter="$dispatch('pause-auto-dismiss')" x-on:mouseleave="$dispatch('resume-auto-dismiss')"
         class="group pointer-events-none fixed inset-x-8 top-0 z-99 flex max-w-full flex-col gap-2 bg-transparent px-4 py-6 md:top-0 md:left-[unset] md:right-0 md:bottom-[unset] md:max-w-lg">
             ...
             <div>
                 ...
                 <template x-if="notification.variant === 'info'">
                     <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                         ...
                         <div
                             class="flex w-full items-center gap-2.5 bg-info/10 rounded-radius p-2 transition-all duration-300">

                             <!-- Icon -->
                             <div class="rounded-full bg-info/15 p-0.5 text-info" aria-hidden="true">
                                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20"
                                     class="h-4 md:h-5 w-4 md:w-5" fill="currentColor" class="size-5"
                                     aria-hidden="true">
                             ...
                             <div class="flex flex-col gap-2">
                                 <h3 x-cloak x-show="notification.title"
                                     class="text-xs md:text-sm font-semibold text-info" x-text="notification.title">
                                 </h3>
                                 <p x-cloak x-show="notification.message" class="text-pretty text-[10px] md:text-xs"
                             ...
                             <button type="button" class="ml-auto" aria-label="dismiss notification"
                                 ...
                                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor"
                                     fill="none" stroke-width="2" class="h-3 w-3 md:h-4 md:w-4" aria-hidden="true">
                 ...
                 <template x-if="notification.variant === 'success'">
                     <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                         ...
                         x-transition:leave-start="translate-x-0 opacity-100">
                         <div
                             class="flex w-full items-center gap-2.5 bg-success/10 rounded-radius p-2 transition-all duration-300">
                             ...
                             <div class="flex flex-col gap-2">
                                 <h3 x-cloak x-show="notification.title"
                                     class="text-xs md:text-sm font-semibold text-success" x-text="notification.title">
                                 </h3>
                                 <p x-cloak x-show="notification.message" class="text-pretty text-[10px] md:text-xs"
                                     x-text="notification.message"></p>
                             </div>
                 ...
                 <template x-if="notification.variant === 'warning'">
                     <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                         ...
                         x-transition:leave-start="translate-x-0 opacity-100">
                         <div
                             class="flex w-full items-center gap-2.5 bg-warning/10 rounded-radius p-2 transition-all duration-300">
                             ...
                             <div class="flex flex-col gap-2">
                                 <h3 x-cloak x-show="notification.title"
                                     class="text-xs md:text-sm font-semibold text-warning"
                             ...
                             <button type="button" class="ml-auto" aria-label="dismiss notification"
                                 x-on:click="(isVisible = false), removeNotification(notification.id)">
                                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor"
                                     fill="none" stroke-width="2" class="h-3 w-3 md:h-4 md:w-4"
                                     aria-hidden="true">
                                     <path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" />
                                 </svg>
                             </button>
                 ...
                 <template x-if="notification.variant === 'danger'">
                     <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                         ...
                         x-transition:leave-start="translate-x-0 opacity-100">
                         <div
                             class="flex w-full items-center gap-2.5 bg-danger/10 rounded-radius p-2 transition-all duration-300">
                             ...
                             <div class="flex flex-col gap-2">
                                 <h3 x-cloak x-show="notification.title"
                                     class="text-xs md:text-sm font-semibold text-danger" x-text="notification.title">
                                 </h3>
                                 <p x-cloak x-show="notification.message" class="text-pretty text-[10px] md:text-xs"
                                     x-text="notification.message"></p>
                             </div>
                 ...
                 <template x-if="notification.variant === 'message'">
                     <div x-data="{ isVisible: false, timeout: null }" x-cloak x-show="isVisible"
                         ...
                         x-transition:leave-start="translate-x-0 opacity-100">
                         <div
                             class="flex w-full rounded-radius items-center gap-2.5 bg-surface-alt p-2 transition-all duration-300 dark:bg-surface-dark-alt">
                             <div class="flex w-full items-center gap-2.5">
                                 ...
                                 <div class="flex flex-col items-start gap-2">
                                     ...
                                     <h3 x-cloak x-show="notification.sender.name"
                                         class="text-xs md:text-sm font-semibold text-on-surface-strong dark:text-on-surface-dark-strong"
                                         x-text="notification.sender.name"></h3>
                                     <p x-cloak x-show="notification.message"
                                         class="text-pretty text-[10px] md:text-xs" x-text="notification.message"></p>
